        ...
        for nt in cutlass.range_constexpr(self.p8_n8_per_warp):
            ...
            for blk in cutlass.range_constexpr(self.mma_m_blocks):
                ...
                if cutlass.const_expr(self.scale_sandwich):
                    st_shared_u32(epilogue_base + (row_lo * Int32(self.tile_n) + col) * Int32(2), _p8_pack_f32x2_to_half2(alpha_value * gate_fragment[0], alpha_value * gate_fragment[1]))
                    st_shared_u32(epilogue_base + (row_hi * Int32(self.tile_n) + col) * Int32(2), _p8_pack_f32x2_to_half2(alpha_value * gate_fragment[2], alpha_value * gate_fragment[3]))
                    st_shared_u32(up_epilogue_base + (row_lo * Int32(self.tile_n) + col) * Int32(2), _p8_pack_f32x2_to_half2(alpha_value * up_fragment[0], alpha_value * up_fragment[1]))
                    st_shared_u32(up_epilogue_base + (row_hi * Int32(self.tile_n) + col) * Int32(2), _p8_pack_f32x2_to_half2(alpha_value * up_fragment[2], alpha_value * up_fragment[3]))
                else:
                    ...
                    st_shared_u32(epilogue_base + (row_lo * Int32(self.tile_n) + col) * Int32(2), pack_f32x2_to_bfloat2(act0, act1))
                    st_shared_u32(epilogue_base + (row_hi * Int32(self.tile_n) + col) * Int32(2), pack_f32x2_to_bfloat2(act2, act3))
        cute.arch.sync_threads()
                ...
                if hrow < valid_rows:
                    ...
                    for segment in cutlass.range_constexpr(2):
                        ...
                        for component in cutlass.range_constexpr(4):
                            ...
                            source_addr = epilogue_base + (hrow * Int32(128) + source_col) * Int32(2)
                            if atom & Int32(1) != Int32(0):
                                source_addr = up_epilogue_base + (hrow * Int32(128) + source_col) * Int32(2)
