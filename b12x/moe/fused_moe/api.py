...
from .source import Exl3TrellisSource, PackedSource, PackedSourceFormat, W13Layout, WeightSource
from .weights import (
    Exl3TrellisWeights,
    PackedWeights,
    PreparedExperts,
...
def prepare_weights(
    *, plan: WeightPlan, weights: PackedWeights | TrellisWeights | Exl3TrellisWeights
) -> PreparedExperts:
