...
def quantize_block_fp8_linear_input_mxfp8(
    ...
    *,
    ...
    _run_block_fp8_quant_kernel(
        source_tk, out.values, out.scale_rows, out.scale_mma, tokens, in_features,
        min_amax=min_amax, activation_block_size=activation_block_size,
    )
    return out
...
def _block_fp8_linear_mxfp8_fused_op(
    ...
    x_q = _quantize_block_fp8_linear_input_for_immediate_gemm(
        source_2d, activation_block_size=activation_block_size, expected_m=None if expected_m == 0 else expected_m,
...
def block_fp8_linear_mxfp8(
    ...
    *,
    ...
    _run_block_fp8_quant_kernel(
        ...
        activation_block_size=int(activation_block_size), min_amax=1e-4 if packed_weight.block_size == (32, 32) else 0.0,
    )
