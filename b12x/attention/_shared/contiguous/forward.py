...
from b12x.attention._shared.contiguous.mask import (
    AttentionMask,
)
...
from b12x.attention._shared.contiguous.block_info import (
    BlockInfo,
)
from b12x.attention._shared.contiguous.pack_gqa import (
    PackGQA,
    pack_gqa_layout,
)
from b12x.attention._shared.contiguous.named_barrier import (
    NamedBarrierFwd,
)
from b12x.attention._shared.contiguous.tile_scheduler import (
    SingleTileScheduler,
...
class ContiguousAttentionForwardKernel:
    ...
    def __init__(
        ...
        assert self.score_mod is None, (
            "score_mod is not part of the initial b12x transplant"
        )
        assert self.mask_mod is None, (
            "mask_mod is not part of the initial b12x transplant"
        )
