...
_PARTIALS = 1 + _MIXES
_PARTIALS_PER_CTA = 2
_MHC_PDL = os.getenv("SPARKINFER_MHC_PDL", "0") != "0"
...
_THREADS = 128
_PREFILL_THREADS = int(os.getenv("SPARKINFER_MHC_PREFILL_THREADS", "512"))
_PREFILL_GRAM_THREADS = int(
    os.getenv(
        "SPARKINFER_MHC_PREFILL_GRAM_THREADS",
        os.getenv("SPARKINFER_MHC_PREFILL_THREADS", "1024"),
    )
)
_PREFILL_BLOCK_M = 2
...
_PREFILL_TF32_TMA_M_WARPS = int(
    os.getenv(
        ...
        os.getenv(
            ...
            os.getenv("SPARKINFER_MHC_PREFILL_TMA_WARPS", "1"),
        ),
    )
)
...
_PREFILL_TF32_TMA_TILE_M = int(
    os.getenv(
        ...
        os.getenv("SPARKINFER_MHC_PREFILL_TMA_TILE_M", "16"),
    )
)
_PREFILL_TF32_TMA_TILE_N = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_TILE_N", "8")
)
_PREFILL_TF32_TMA_TILE_K = int(
    os.getenv(
        "SPARKINFER_MHC_PREFILL_TF32_TMA_TILE_K",
        os.getenv("SPARKINFER_MHC_PREFILL_TMA_TILE_K", "256"),
    )
)
_PREFILL_TF32_TMA_STAGES = int(
    os.getenv(
        "SPARKINFER_MHC_PREFILL_TF32_TMA_STAGES",
        os.getenv("SPARKINFER_MHC_PREFILL_TMA_STAGES", "1"),
    )
)
_PREFILL_TF32_TMA_CHUNK_MIN_TOKENS = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_CHUNK_MIN_TOKENS", "4096")
)
_PREFILL_TF32_TMA_LONG_MIN_TOKENS = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_LONG_MIN_TOKENS", "8192")
)
...
_PREFILL_TF32_TMA_CHUNK_4096_M_WARPS = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_CHUNK_M_WARPS", "12")
)
_PREFILL_TF32_TMA_CHUNK_OTHER_M_WARPS = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_CHUNK_M_WARPS", "2")
)
...
_PREFILL_TF32_TMA_CHUNK_4096_TILE_M = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_CHUNK_TILE_M", "192")
)
_PREFILL_TF32_TMA_CHUNK_OTHER_TILE_M = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_CHUNK_TILE_M", "32")
)
_PREFILL_TF32_TMA_CHUNK_4096_TILE_N = int(
    os.getenv(
        "SPARKINFER_MHC_PREFILL_TF32_TMA_CHUNK_TILE_N",
        os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_TILE_N", "24"),
    )
)
...
_PREFILL_TF32_TMA_CHUNK_4096_TILE_K = int(
    os.getenv(
        ...
        os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_TILE_K", "64"),
    )
)
_PREFILL_TF32_TMA_CHUNK_4096_STAGES = int(
    os.getenv(
        "SPARKINFER_MHC_PREFILL_TF32_TMA_CHUNK_STAGES",
        os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_STAGES", "2"),
    )
)
_PREFILL_TF32_TMA_CHUNK_4096_K_SPLITS = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_CHUNK_K_SPLITS", "8")
)
...
_PREFILL_TF32_TMA_LONG_4096_M_WARPS = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_LONG_M_WARPS", "8")
)
_PREFILL_TF32_TMA_LONG_4096_N_WARPS = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_LONG_N_WARPS", "1")
)
_PREFILL_TF32_TMA_LONG_4096_TILE_M = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_LONG_TILE_M", "128")
)
_PREFILL_TF32_TMA_LONG_4096_TILE_N = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_LONG_TILE_N", "24")
)
_PREFILL_TF32_TMA_LONG_4096_TILE_K = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_LONG_TILE_K", "64")
)
_PREFILL_TF32_TMA_LONG_4096_STAGES = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_LONG_STAGES", "2")
)
_PREFILL_TF32_TMA_LONG_4096_K_SPLITS = int(
    os.getenv("SPARKINFER_MHC_PREFILL_TF32_TMA_LONG_K_SPLITS", "4")
)
_PREFILL_FINALIZE_THREADS = int(
    os.getenv("SPARKINFER_MHC_PREFILL_FINALIZE_THREADS", "256")
)
_POST_PRE_CHUNK = 12
...
def _validate_post_pre_partials_per_cta(partials_per_cta: int) -> int:
    ...
    if partials_per_cta <= 0 or partials_per_cta > _PARTIALS:
        raise ValueError(
            "SPARKINFER_MHC_PARTIALS_PER_CTA must be in "
...
def _selected_post_pre_decode_split_n(
    *,
    ...
    raw_splits = os.environ.get("SPARKINFER_MHC_DECODE_SPLITS")
    if raw_splits is not None and raw_splits != "":
        try:
            splits = int(raw_splits)
            tile_n = int(os.environ.get("SPARKINFER_MHC_DECODE_TILE_N", "3"))
        except ValueError as exc:
            raise ValueError(
                "SPARKINFER_MHC_DECODE_SPLITS and SPARKINFER_MHC_DECODE_TILE_N must be integers"
            ) from exc
        if splits == 0:
            return 0, 0
    else:
    ...
    if splits <= 0 or splits > _SOURCE_TILES or int(hidden_size) % splits != 0:
        raise ValueError(
            "SPARKINFER_MHC_DECODE_SPLITS must be a positive divisor of hidden_size "
            f"no larger than {_SOURCE_TILES}, got {splits}"
        )
    if tile_n <= 0 or _MIXES % tile_n != 0:
        raise ValueError(
            f"SPARKINFER_MHC_DECODE_TILE_N must divide {_MIXES}, got {tile_n}"
        )
...
def _selected_mhc_decode_finalize_threads(
    *,
    ...
    raw = os.environ.get("SPARKINFER_MHC_DECODE_FINALIZE_THREADS")
    if raw is not None and raw != "":
        try:
            threads = int(raw)
        except ValueError as exc:
            raise ValueError(
                f"invalid SPARKINFER_MHC_DECODE_FINALIZE_THREADS={raw!r}"
            ) from exc
    else:
        if compute_capability is None and torch.cuda.is_available():
            compute_capability = tuple(torch.cuda.get_device_capability())
    ...
    if (
        ...
        raise ValueError(
            "SPARKINFER_MHC_DECODE_FINALIZE_THREADS must be a positive multiple of "
...
def _selected_post_pre_partials_per_cta(
    *,
    ...
    raw = os.environ.get("SPARKINFER_MHC_PARTIALS_PER_CTA")
    if raw is not None and raw != "":
        try:
...
def _run_mhc_post_pre_partial_launch(
    *,
    ...
    raw_bf16x2 = os.environ.get("SPARKINFER_MHC_DECODE_BF16X2")
    decode_bf16x2 = (
        raw_bf16x2 != "0"
...
@torch.library.custom_op(
    "sparkinfer::mhc_post_pre_partial_launch",
...
@torch.library.custom_op(
    "sparkinfer::mhc_post_pre_prefill_partial_launch",
    mutates_args=("partials", "out"),
)
...
def run_mhc_post_pre_prefill_partial(
    *,
    ...
    torch.ops.sparkinfer.mhc_post_pre_prefill_partial_launch(
        x,
        residual,
        prev_post,
        prev_comb,
...
@torch.library.custom_op(
    "sparkinfer::mhc_post_pre_prefill_block_m_partial_launch",
    mutates_args=("partials", "out"),
)
...
def run_mhc_post_pre_prefill_block_m_partial(
    *,
    ...
    torch.ops.sparkinfer.mhc_post_pre_prefill_block_m_partial_launch(
        x,
        residual,
        prev_post,
        prev_comb,
...
@torch.library.custom_op(
    "sparkinfer::mhc_post_pre_prefill_gram_launch",
    mutates_args=("partials", "out"),
)
...
def run_mhc_post_pre_prefill_gram(
    *,
    ...
    torch.ops.sparkinfer.mhc_post_pre_prefill_gram_launch(
        x,
        residual,
        prev_post,
        prev_comb,
...
def _run_mhc_prefill_bf16_project_launch(
    *,
    ...
    if os.getenv("SPARKINFER_MHC_PREFILL_BF16_TMA", "1") != "0":
...
@torch.library.custom_op(
    "sparkinfer::mhc_prefill_bf16_project_launch",
...
def run_mhc_prefill_bf16_project(
    *,
    ...
    torch.ops.sparkinfer.mhc_prefill_bf16_project_launch(
        out,
        fn_bf16,
        partials,
    )
...
@torch.library.custom_op(
    "sparkinfer::mhc_prefill_tf32_project_launch",
    mutates_args=("partials",),
)
...
def run_mhc_prefill_tf32_project(
    *,
    ...
    torch.ops.sparkinfer.mhc_prefill_tf32_project_launch(
        out,
        fn,
        partials,
    )
...
@torch.library.custom_op(
    "sparkinfer::mhc_post_pre_partial_alloc",
    mutates_args=(),
)
...
def run_mhc_post_pre_partial_alloc(
    *,
    ...
    return torch.ops.sparkinfer.mhc_post_pre_partial_alloc(
...
def run_mhc_post(
    *,
    ...
    torch.ops.sparkinfer.mhc_post_launch(
        x,
        residual,
        prev_post,
        prev_comb,
...
@torch.library.custom_op(
    "sparkinfer::mhc_pre_partial_launch",
    mutates_args=("partials", "out"),
)
...
def run_mhc_pre_partial(
    *,
    ...
    torch.ops.sparkinfer.mhc_pre_partial_launch(
        residual,
        fn,
        partials,
        out,
...
@torch.library.custom_op(
    "sparkinfer::mhc_finalize_gram_launch",
...
@torch.library.custom_op(
    "sparkinfer::mhc_post_launch_functional",
    mutates_args=(),
)
...
def run_mhc_post_functional(
    *,
    ...
    return torch.ops.sparkinfer.mhc_post_launch_functional(
        x,
        residual,
        prev_post,
        prev_comb,
...
@torch.library.custom_op(
    "sparkinfer::mhc_pre_launch_functional",
    mutates_args=(),
)
...
def run_mhc_pre_functional(
    *,
    ...
    return torch.ops.sparkinfer.mhc_pre_launch_functional(
        residual,
        fn,
        scale,
        bias,
...
@torch.library.custom_op(
    "sparkinfer::mhc_post_pre_launch_functional",
    mutates_args=(),
)
...
def run_mhc_post_pre_functional(
    *,
    ...
    norm_weight_for_kernel = norm_weight if norm_weight is not None else residual
    return torch.ops.sparkinfer.mhc_post_pre_launch_functional(
        x,
        residual,
        prev_post,
        prev_comb,
